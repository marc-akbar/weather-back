...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascripts/packs/application.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascripts/channels sync recursive _channel\\.js$":
/*!*****************************************************!*\
  !*** ./app/javascripts/channels sync _channel\.js$ ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var map = {
	"./weather_channel.js": "./app/javascripts/channels/weather_channel.js"
};
...
webpackContext.id = "./app/javascripts/channels sync recursive _channel\\.js$";
...
var channels = __webpack_require__("./app/javascripts/channels sync recursive _channel\\.js$");

channels.keys().forEach(channels);

/***/ }),

/***/ "./app/javascripts/channels/weather_channel.js":
/*!*****************************************************!*\
  !*** ./app/javascripts/channels/weather_channel.js ***!
  \*****************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _consumer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./consumer */ "./app/javascripts/channels/consumer.js");

_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("WeatherChannel", {
  ...
  received: function received(data) {
    ...
    var scene = $('.scene')[0].classList[2];
    console.log(updated_data['currently']['icon']);
    $('.scene')[0].classList.add('cloudy');
    $('.scene')[0].classList.remove(scene);
    $('.info-summary')[0].innerHTML = updated_data['hourly']['summary'];
    $('.update-time-value')[0].innerHTML = formatAMPM(date);

    for (var _i = 0, _Object$entries = Object.entries(updated_data['currently']); _i < _Object$entries.length; _i++) {
      var obj = _Object$entries[_i];

      if ($(".".concat(obj[0], "-value")).length > 0) {
        if ($(".".concat(obj[0]))[0].innerText.slice(-1) === "%") {
          $(".".concat(obj[0], "-value"))[0].innerHTML = obj[1] * 100;
        } else {
          $(".".concat(obj[0], "-value"))[0].innerHTML = obj[1];
        }
...
__webpack_require__(/*! channels */ "./app/javascripts/channels/index.js");
...
/******/ });
//# sourceMappingURL=application-1915f13b56146d41a15e.js.map