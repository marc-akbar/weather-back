...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("WeatherChannel", {
  ...
  received: function received(data) {
    ...
    for (var _i = 0, _Object$keys = Object.keys(updated_data['currently']); _i < _Object$keys.length; _i++) {
      var key = _Object$keys[_i];
      console.log(key);

      if ($(".".concat(key, "-value")).length > 1) {
        $(".".concat(key, "-value"))[0].innerHTML = Math.random();
      }
...
/******/ });
//# sourceMappingURL=application-acf70047cd2b9bcec58a.js.map